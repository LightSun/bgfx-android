...
namespace heaven7_Bgfx_demo {
    ...
    void CallbackDemo::init() {
        ...
        m_reset  = 0
                   ...
                   | BGFX_RESET_MSAA_X16
                ;
        _callback = new BgfxCallback();
        _allocator = new BgfxAllocator();
    ...
    void CallbackDemo::destroy() {
        ...
        BaseDemo::destroy();
        _allocator->dumpStats();

        DESTROY_POINTER(_callback);
        DESTROY_POINTER(_allocator);
    }
    int CallbackDemo::draw() {
