...
namespace heaven7_Bgfx_demo {
    ...
    void FontDemo::init() {
        ...
        for (uint32_t ii = 0; ii < numFonts; ++ii) {
            ...
            m_fontManager->preloadGlyph(m_fonts[ii],
        ...
        for (uint32_t ii = 0; ii < numFonts; ++ii) {
            ...
            m_textBufferManager->appendText(m_staticText, m_fonts[ii],
        ...
        m_transientText = m_textBufferManager->createTextBuffer(FONT_TYPE_ALPHA,
    ...
    int FontDemo::draw() {
        ...
        const bgfx::Caps *caps = bgfx::getCaps();
        {
            float ortho[16];
            bx::mtxOrtho(
                    ortho, centering, m_width + centering, m_height + centering, centering, 0.0f,
                    100.0f, 0.0f, caps->homogeneousDepth
            );
