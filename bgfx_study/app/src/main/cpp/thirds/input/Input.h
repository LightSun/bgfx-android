  ...
  * */
    ...
    public:
        ...
        public:
            ...
            const static int NUM_0 = 7;
            const static int NUM_1 = 8;
            const static int NUM_2 = 9;
            const static int NUM_3 = 10;
            const static int NUM_4 = 11;
            const static int NUM_5 = 12;
            const static int NUM_6 = 13;
            const static int NUM_7 = 14;
            const static int NUM_8 = 15;
            const static int NUM_9 = 16;
            const static int A = 29;
            const static int ALT_LEFT = 57;
            const static int ALT_RIGHT = 58;
            const static int APOSTROPHE = 75;
            const static int AT = 77;
            const static int B = 30;
            const static int BACK = 4;
            const static int BACKSLASH = 73;
            const static int C = 31;
            const static int CALL = 5;
            const static int CAMERA = 27;
            const static int CLEAR = 28;
            const static int COMMA = 55;
            const static int D = 32;
            const static int DEL = 67;
            const static int BACKSPACE = 67;
            const static int FORWARD_DEL = 112;
            const static int DPAD_CENTER = 23;
            const static int DPAD_DOWN = 20;
            const static int DPAD_LEFT = 21;
            const static int DPAD_RIGHT = 22;
            const static int DPAD_UP = 19;
            const static int CENTER = 23;
            const static int DOWN = 20;
            const static int LEFT = 21;
            const static int RIGHT = 22;
            const static int UP = 19;
            const static int E = 33;
            const static int ENDCALL = 6;
            const static int ENTER = 66;
            const static int ENVELOPE = 65;
            const static int EQUALS = 70;
            const static int EXPLORER = 64;
            const static int F = 34;
            const static int FOCUS = 80;
            const static int G = 35;
            const static int GRAVE = 68;
            const static int H = 36;
            const static int HEADSETHOOK = 79;
            const static int HOME = 3;
            const static int I = 37;
            const static int J = 38;
            const static int K = 39;
            const static int L = 40;
            const static int LEFT_BRACKET = 71;
            const static int M = 41;
            const static int MEDIA_FAST_FORWARD = 90;
            const static int MEDIA_NEXT = 87;
            const static int MEDIA_PLAY_PAUSE = 85;
            const static int MEDIA_PREVIOUS = 88;
            const static int MEDIA_REWIND = 89;
            const static int MEDIA_STOP = 86;
            const static int MENU = 82;
            const static int MINUS = 69;
            const static int MUTE = 91;
            const static int N = 42;
            const static int NOTIFICATION = 83;
            const static int NUM = 78;
            const static int O = 43;
            const static int P = 44;
            const static int PERIOD = 56;
            const static int PLUS = 81;
            const static int POUND = 18;
            const static int POWER = 26;
            const static int Q = 45;
            const static int R = 46;
            const static int RIGHT_BRACKET = 72;
            const static int S = 47;
            const static int SEARCH = 84;
            const static int SEMICOLON = 74;
            const static int SHIFT_LEFT = 59;
            const static int SHIFT_RIGHT = 60;
            const static int SLASH = 76;
            const static int SOFT_LEFT = 1;
            const static int SOFT_RIGHT = 2;
            const static int SPACE = 62;
            const static int STAR = 17;
            const static int SYM = 63;
            const static int T = 48;
            const static int TAB = 61;
            const static int U = 49;
            const static int UNKNOWN = 0;
            const static int V = 50;
            const static int VOLUME_DOWN = 25;
            const static int VOLUME_UP = 24;
            const static int W = 51;
            const static int X = 52;
            const static int Y = 53;
            const static int Z = 54;
            const static int META_ALT_LEFT_ON = 16;
            const static int META_ALT_ON = 2;
            const static int META_ALT_RIGHT_ON = 32;
            const static int META_SHIFT_LEFT_ON = 64;
            const static int META_SHIFT_ON = 1;
            const static int META_SHIFT_RIGHT_ON = 128;
            const static int META_SYM_ON = 4;
            const static int CONTROL_LEFT = 129;
            const static int CONTROL_RIGHT = 130;
            const static int ESCAPE = 131;
            const static int END = 132;
            const static int INSERT = 133;
            const static int PAGE_UP = 92;
            const static int PAGE_DOWN = 93;
            const static int PICTSYMBOLS = 94;
            const static int SWITCH_CHARSET = 95;
            const static int BUTTON_CIRCLE = 255;
            const static int BUTTON_A = 96;
            const static int BUTTON_B = 97;
            const static int BUTTON_C = 98;
            const static int BUTTON_X = 99;
            const static int BUTTON_Y = 100;
            const static int BUTTON_Z = 101;
            const static int BUTTON_L1 = 102;
            const static int BUTTON_R1 = 103;
            const static int BUTTON_L2 = 104;
            const static int BUTTON_R2 = 105;
            const static int BUTTON_THUMBL = 106;
            const static int BUTTON_THUMBR = 107;
            const static int BUTTON_START = 108;
            const static int BUTTON_SELECT = 109;
            const static int BUTTON_MODE = 110;

            const static int NUMPAD_0 = 144;
            const static int NUMPAD_1 = 145;
            const static int NUMPAD_2 = 146;
            const static int NUMPAD_3 = 147;
            const static int NUMPAD_4 = 148;
            const static int NUMPAD_5 = 149;
            const static int NUMPAD_6 = 150;
            const static int NUMPAD_7 = 151;
            const static int NUMPAD_8 = 152;
            const static int NUMPAD_9 = 153;
...
// ! | VK_EXCLAMATION
// ? | VK_QUESTION
            const static int COLON = 243;
            const static int F1 = 244;
            const static int F2 = 245;
            const static int F3 = 246;
            const static int F4 = 247;
            const static int F5 = 248;
            const static int F6 = 249;
            const static int F7 = 250;
            const static int F8 = 251;
            const static int F9 = 252;
            const static int F10 = 253;
            const static int F11 = 254;
            const static int F12 = 255;

            const static int MAX_KEYCODE = 255;
        ...
        private:
            static h7::Map<const char *, int> *keyNames;
